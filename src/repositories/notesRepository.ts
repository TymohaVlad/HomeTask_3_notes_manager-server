...
let notes: Note[] = [
    ...
    { id: 2, name: "Note name 2", date: "2023-07-24", category: "Random thought", content: "Some Contetn here", archived: false },
    ...
    { id: 5, name: "Note name 5", date: "2023-07-27", category: "Task", content: "Some Contetn here", archived: false },
